    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentalAdditionalService", x => new { x.AdditionalServiceId, x.RentalId });
                    table.ForeignKey(
                        name: "FK_RentalAdditionalService_AdditionalServices_AdditionalServiceId",
                        column: x => x.AdditionalServiceId,
                        principalTable: "AdditionalServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RentalAdditionalService_Rentals_RentalId",
                        column: x => x.RentalId,
                        principalTable: "Rentals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "DailyRate", "Description", "Name" },
                values: new object[,]
                {
                    { 1, 10m, "GPS navigation system", "GPS Navigation" },
                    { 2, 15m, "Child safety seat", "Child Seat" },
                    { 3, 25m, "Comprehensive insurance coverage", "Additional Insurance" },
                    { 4, 20m, "Add another authorized driver", "Additional Driver" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Premium vehicles with luxury features", "Luxury" },
                    { 3, "Spacious sport utility vehicles", "SUV" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentalAdditionalService_RentalId",
                table: "RentalAdditionalService",
                column: "RentalId");
